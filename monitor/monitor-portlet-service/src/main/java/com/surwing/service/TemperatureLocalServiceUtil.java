 ...
 * {@link com.surwing.service.impl.TemperatureLocalServiceImpl} and is the
 ...
 * @see com.surwing.service.impl.TemperatureLocalServiceImpl
 * @generated
 */
public class TemperatureLocalServiceUtil {
    private static TemperatureLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.surwing.service.impl.TemperatureLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.surwing.model.Temperature addTemperature(
    ...
    */
    public static com.surwing.model.Temperature createTemperature(
        long temperatureId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.surwing.model.Temperature deleteTemperature(
        long temperatureId)
    ...
    */
    ...
    public static com.surwing.model.Temperature fetchTemperature(
        long temperatureId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.surwing.model.Temperature getTemperature(
        long temperatureId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.surwing.model.Temperature> getTemperatures(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.surwing.model.Temperature updateTemperature(
        com.surwing.model.Temperature temperature)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static com.surwing.model.Temperature addTemperature(long patientId,
        java.math.BigDecimal temperature)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().addTemperature(patientId, temperature);
    }

    public static com.surwing.model.Temperature getPatientTemperatureIn8h(
        long patientId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getPatientTemperatureIn8h(patientId);
    }

    public static java.math.BigDecimal getCurrentHourTemperature(
        long patientId, java.util.Date currentHour)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getCurrentHourTemperature(patientId, currentHour);
    }

    public static boolean hasTodayRecords(long patientId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().hasTodayRecords(patientId);
    }
    ...
    public static TemperatureLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    TemperatureLocalService.class.getName());

            if (invokableLocalService instanceof TemperatureLocalService) {
                _service = (TemperatureLocalService) invokableLocalService;
            } else {
                _service = new TemperatureLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(TemperatureLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(TemperatureLocalService service) {
    }
}
