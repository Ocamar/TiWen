...
/**
 * Provides the local service interface for Node. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author zhaiyz
 * @see NodeLocalServiceUtil
...
public interface NodeLocalService extends BaseLocalService, InvokableLocalService,
    PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link NodeLocalServiceUtil} to access the node local service. Add custom service methods to {@link com.surwing.service.impl.NodeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
