 ...
 * @generated
 */
public class NodeLocalServiceClp implements NodeLocalService {
    ...
    public NodeLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "addNode";

        _methodParameterTypes19 = new String[] {
                "long", "int", "java.lang.String", "long", "long"
            };

        _methodName20 = "countNodesByDisplayTerms";

        _methodParameterTypes20 = new String[] {
                "com.surwing.search.NodeDisplayTerms", "long", "long"
            };

        _methodName21 = "findNodesByDisplayTerms";
        ...
        _methodName22 = "updateNodeInfo";

        _methodParameterTypes22 = new String[] { "com.surwing.model.Node" };

        _methodName23 = "fetchByNodeNo";

        _methodParameterTypes23 = new String[] { "java.lang.String" };

        _methodName24 = "updateNodeStatusToTimeout";
    ...
    public com.surwing.model.Node addNode(com.surwing.model.Node node)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(node) });
        } catch (Throwable t) {
        ...
        return (com.surwing.model.Node) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.surwing.model.Node createNode(long nodeId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { nodeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.surwing.model.Node deleteNode(long nodeId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { nodeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.surwing.model.Node fetchNode(long nodeId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { nodeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.surwing.model.Node getNode(long nodeId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { nodeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.surwing.model.Node> getNodes(int start, int end)
        ...
        return (java.util.List<com.surwing.model.Node>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.surwing.model.Node addNode(long locationId, int nodeType,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    ClpSerializer.translateInput(nodeNo),
    ...
    public com.surwing.model.Node fetchByNodeNo(java.lang.String nodeNo)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    ...
                    new Object[] { ClpSerializer.translateInput(nodeNo) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
