...
/**
 * Provides the local service interface for SystemParameter. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author zhaiyz
 * @see SystemParameterLocalServiceUtil
...
public interface SystemParameterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link SystemParameterLocalServiceUtil} to access the system parameter local service. Add custom service methods to {@link com.surwing.service.impl.SystemParameterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
