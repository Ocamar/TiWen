 ...
 * @generated
 */
public class BedLocalServiceClp implements BedLocalService {
    ...
    public BedLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName20 = "findByDisplayTerms";
        ...
        _methodName21 = "countByDisplayTerms";
        ...
        _methodName22 = "findByLocationId";

        _methodParameterTypes22 = new String[] { "long" };

        _methodName23 = "countByLocationId";

        _methodParameterTypes23 = new String[] { "long" };

        _methodName24 = "bindPatient";

        _methodParameterTypes24 = new String[] { "long", "long" };

        _methodName25 = "unbindPatient";

        _methodParameterTypes25 = new String[] { "long" };

        _methodName26 = "findUsableBeds";

        _methodParameterTypes26 = new String[] { "long" };

        _methodName27 = "getByBedAlias";
    ...
    public com.surwing.model.Bed addBed(com.surwing.model.Bed bed)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(bed) });
        } catch (Throwable t) {
        ...
        return (com.surwing.model.Bed) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.surwing.model.Bed createBed(long bedId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { bedId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.surwing.model.Bed deleteBed(long bedId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { bedId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.surwing.model.Bed fetchBed(long bedId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { bedId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.surwing.model.Bed getBed(long bedId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { bedId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.surwing.model.Bed> getBeds(int start, int end)
        ...
        return (java.util.List<com.surwing.model.Bed>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public void addBeds(java.lang.String fromNo, int count, long areaId,
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName19,
                ...
                new Object[] {
                    ClpSerializer.translateInput(fromNo),
    ...
    public java.util.List<com.surwing.model.Bed> findByLocationId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    _methodParameterTypes22, new Object[] { locationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public int countByLocationId(long locationId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    _methodParameterTypes23, new Object[] { locationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public void bindPatient(long bedId, long patientId)
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName24,
                _methodParameterTypes24, new Object[] { bedId, patientId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public void unbindPatient(long bedId)
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName25,
                _methodParameterTypes25, new Object[] { bedId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.surwing.model.Bed> findUsableBeds(long locationId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName26,
                    _methodParameterTypes26, new Object[] { locationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.surwing.model.Bed getByBedAlias(long locationId,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName27,
                    ...
                    ClpSerializer.translateInput(bedAlias)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
