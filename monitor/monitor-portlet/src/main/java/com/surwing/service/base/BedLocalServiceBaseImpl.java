...
import com.surwing.service.BedLocalService;
...
/**
 * Provides the base implementation for the bed local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.surwing.service.impl.BedLocalServiceImpl}.
 * </p>
 *
 * @author zhaiyz
 ...
 * @generated
 */
public abstract class BedLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements BedLocalService, IdentifiableBean {
    ...
    private BedLocalServiceClpInvoker _clpInvoker = new BedLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.surwing.service.BedLocalServiceUtil} to access the bed local service.
     */
    ...
    @Override
    public Bed addBed(Bed bed) throws SystemException {
        bed.setNew(true);

        return bedPersistence.update(bed);
    }
     ...
     */
    @Override
    public Bed createBed(long bedId) {
        return bedPersistence.create(bedId);
    }
    ...
    public Bed deleteBed(long bedId) throws PortalException, SystemException {
        return bedPersistence.remove(bedId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Bed deleteBed(Bed bed) throws SystemException {
        return bedPersistence.remove(bed);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Bed.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return bedPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return bedPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return bedPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return bedPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Bed fetchBed(long bedId) throws SystemException {
        return bedPersistence.fetchByPrimaryKey(bedId);
    }
     ...
     */
    @Override
    public Bed getBed(long bedId) throws PortalException, SystemException {
        return bedPersistence.findByPrimaryKey(bedId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return bedPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Bed> getBeds(int start, int end) throws SystemException {
        return bedPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getBedsCount() throws SystemException {
        return bedPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Bed updateBed(Bed bed) throws SystemException {
        return bedPersistence.update(bed);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.surwing.model.Bed",
            bedLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.surwing.model.Bed");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = bedPersistence.getDataSource();
