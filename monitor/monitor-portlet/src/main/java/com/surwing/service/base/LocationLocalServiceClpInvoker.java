...
public class LocationLocalServiceClpInvoker {
    ...
    public LocationLocalServiceClpInvoker() {
        ...
        _methodName67 = "getLocationsCountByC_G";

        _methodParameterTypes67 = new String[] { "long", "long" };

        _methodName68 = "getLocationsByC_G";

        _methodParameterTypes68 = new String[] { "long", "long", "int", "int" };

        _methodName69 = "updateLocationInfo";

        _methodParameterTypes69 = new String[] { "com.surwing.model.Location" };

        _methodName70 = "deleteLocation";

        _methodParameterTypes70 = new String[] { "long" };

        _methodName71 = "findByDisplayTerms";
        ...
        _methodName72 = "countByDisplayTerms";

        _methodParameterTypes72 = new String[] {
                "com.surwing.search.LocationDisplayTerms"
            };

        _methodName73 = "getEsbEnabledLocations";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return LocationLocalServiceUtil.addLocation((com.surwing.model.Location) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return LocationLocalServiceUtil.deleteLocation((com.surwing.model.Location) arguments[0]);
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return LocationLocalServiceUtil.updateLocation((com.surwing.model.Location) arguments[0]);
        }
        ...
        if (_methodName67.equals(name) &&
            ...
            return LocationLocalServiceUtil.getLocationsCountByC_G(((Long) arguments[0]).longValue(),
                ((Long) arguments[1]).longValue());
        }

        if (_methodName68.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes68, parameterTypes)) {
            return LocationLocalServiceUtil.getLocationsByC_G(((Long) arguments[0]).longValue(),
                ((Long) arguments[1]).longValue(),
                ((Integer) arguments[2]).intValue(),
        ...
        if (_methodName69.equals(name) &&
            ...
            return LocationLocalServiceUtil.updateLocationInfo((com.surwing.model.Location) arguments[0]);
        }
        ...
        if (_methodName71.equals(name) &&
            ...
            return LocationLocalServiceUtil.findByDisplayTerms((com.surwing.search.LocationDisplayTerms) arguments[0],
        ...
        if (_methodName72.equals(name) &&
            ...
            return LocationLocalServiceUtil.countByDisplayTerms((com.surwing.search.LocationDisplayTerms) arguments[0]);
        }

        if (_methodName73.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes73, parameterTypes)) {
            return LocationLocalServiceUtil.getEsbEnabledLocations();
        }
